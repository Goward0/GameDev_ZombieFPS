...
public class GunScript : MonoBehaviour {
	...
	[Header("Gun Stats")]
	[Tooltip("Damage this gun does per bullet.")]
	...
	public void SetDoubleDamage(bool value) => doubleDamage = value;
	...
	private void ShootMethod()
{
    ...
    {
        if (infiniteAmmo || bulletsInTheGun > 0)
        {
            ...
            if (bullet)
            {
                ...
                float finalDamage = doubleDamage ? weaponDamage * 2f : weaponDamage;
            ...
            holdFlash = Instantiate(muzzelFlash[randomNumberForMuzzelFlash], muzzelSpawn.transform.position, muzzelSpawn.transform.rotation * Quaternion.Euler(0, 0, 90));
